...
find ~/www/ctrip/corp-fe-prefetch/  -type d -name node_modules -prune -o -type f -print | xargs grep -rl '@cotrip/'  ~/www/ctrip/corp-fe-prefetch/ | xargs sed -i 's/@cotrip/@cotrip/g'
