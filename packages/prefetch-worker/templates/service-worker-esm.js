 ...
 * 
 * 这是一个完整的 Service Worker 模板，使用 ESM 方式导入 prefetch-worker
 * 适用于支持 ESM 的现代浏览器环境
 * 
 * 使用方法：
...
// 导入 prefetch-worker 的核心功能
import { 
  setupLifecycle, 
  initializePrefetchWorker 
} from `${CDN_BASE}/dist/prefetch-worker.esm.js`;

console.log('Service Worker: Loading with ESM support');
